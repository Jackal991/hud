...
CreateThread(function()
    ...
    while true do
        if Config.Framework == "esx" or Config.Framework == "oldesx" then
            ...
            if lastHunger == nil or newHunger ~= lastHunger then
                SetStatus('hunger', NewHunger)
                lastHunger = hunger                
            end
            
            if lastThirst == nil or NewThirst ~= lastThirst then
                SetStatus('thirst', NewThirst)
                lastThirst = NewThirst
